...
public class NDT_ThongKe {
    ...
    public int getTongKhachThue() { return tongKhachThue; }
    public void setTongKhachThue(int tongKhachThue) { this.tongKhachThue = tongKhachThue; }
